...
local Cabecalho = Abas.SistemaChave:AddLabel({
    Texto = "Bem-vindo ao MutanoX-HUB!",
...
local Getkey = Tabs.KeySys:AddButton({
    ...
    Callback = function()
       setclipboard(KeyGuardLibrary.getLink())
           ...
           print("Chave é inválida")
        end
    end,
    CorDoTexto = Color3.fromRGB(255, 255, 255),
    CorDeFundo = Color3.fromRGB(0, 120, 215),
    CorDaBorda = Color3.fromRGB(255, 255, 255),
    TamanhoDoTexto = 16,
    Padding = 5,
    BordaRedonda = true, -- Botão com cantos arredondados
})

local ObterChave = Abas.SistemaChave:AddButton({
    Título = "Obter Chave",
    Descrição = "Obtenha a chave aqui",
    Callback = function()
       setclipboard(KeyGuardLibrary.getLink())
    end,
    CorDoTexto = Color3.fromRGB(255, 255, 255),
    CorDeFundo = Color3.fromRGB(0, 150, 136),
    CorDaBorda = Color3.fromRGB(255, 255, 255),
    TamanhoDoTexto = 16,
    Padding = 5,
    BordaRedonda = true,
...
local Creditos = Janela:AddLabel({
    Texto = "Desenvolvido por @MutanoX",
    CorDoTexto = Color3.fromRGB(200, 200, 200),
    TamanhoDoTexto = 14,
    Fonte = Enum.Font.Gotham,
    Posição = UDim2.fromOffset(10, 420),
    CorDeFundo = Color3.fromRGB(20, 20, 20),
    Padding = 5,
    AlinhamentoDoTexto = Enum.TextXAlignment.Center,
})

-- Elementos decorativos adicionais
local LinhaDecorativa = Abas.SistemaChave:AddSeparator({
    Cor = Color3.fromRGB(0, 120, 215), -- Linha de separação para organizar visualmente
})

local CaixaDecorativa = Abas.SistemaChave:AddFrame({
    Tamanho = UDim2.new(0.9, 0, 0.05, 0),
    CorDeFundo = Color3.fromRGB(50, 50, 50),
    BordaRedonda = true,
    Padding = 5,
})

-- Efeitos visuais e animação no carregamento
Janela:AdicionarSombra({
    Intensidade = 0.6,
    Cor = Color3.fromRGB(0, 0, 0),
})

Janela:AdicionarAnimação({
    Tipo = "SlideIn", -- Animação de deslizar para dentro
    Duração = 0.7,
})
