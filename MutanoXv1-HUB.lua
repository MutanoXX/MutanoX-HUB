...
local OrionLib = loadstring(game:HttpGet("https://raw.githubusercontent.com/Orion/main/source"))()
...
local function createLabel(label, position, text)
    ...
    label.Text = text
    label.Parent = MiniMenu
end

createLabel(PlayerCountLabel, UDim2.new(0, 0, 0, 30), "Players: 0")
createLabel(FullMoonCountdownLabel, UDim2.new(0, 0, 0, 55), "Full Moon in: 0 min")
createLabel(EliteBossNotifyLabel, UDim2.new(0, 0, 0, 80), "Elite Boss in: 0 min")
...
for _, option in ipairs(additionalOptions) do
    CustSection:AddToggle(option, {
        ...
        Callback = function(Value)
            ...
            print(option .. " is now " .. (Value and "enabled" or "disabled"))
        end
    })
end
