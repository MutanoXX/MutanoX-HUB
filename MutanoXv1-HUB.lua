...
local Tabs = {
    ...
    Customization = Window:AddTab({ Title = "Customization", Icon = "rbxassetid://113806187616600" })
}

-- Customization Section
local CustomizationSection = Tabs.Customization:AddSection("Customization")

CustomizationSection:AddSlider("Window Size", {
    Title = "Window Size",
    Default = 530,
    Min = 300,
    Max = 800,
    ...
    Callback = function(Value)
        Window.Size = UDim2.fromOffset(Value, 350)
    end
})
...
CustomizationSection:AddDropdown("Theme", {
    Title = "Theme",
    Default = "Darker",
    Options = {"Darker", "Light", "Dark", "Midnight", "Sunrise"},
    Callback = function(Value)
        Window.Theme = Value
    end
})

CustomizationSection:AddToggle("Acrylic", {
    Title = "Acrylic",
    Default = true,
    Callback = function(Value)
...
CustomizationSection:AddColorPicker("Background Color", {
...
CustomizationSection:AddColorPicker("Text Color", {
    Title = "Text Color",
    Default = Color3.fromRGB(0, 0, 0),
    Callback = function(Value)
        Window.TextColor = Value
    end
})

CustomizationSection:AddSlider("Text Size", {
    Title = "Text Size",
    Default = 14,
    Min = 10,
    Max = 24,
    Rounding = 0,
    Callback = function(Value)
        Window.TextSize = Value
    end
})

CustomizationSection:AddDropdown("Font Style", {
    Title = "Font Style",
    Default = "Gotham",
    Options = {"Gotham", "GothamBold", "Arial", "ArialBold", "SourceSans"},
    Callback = function(Value)
        Window.Font = Value
    end
})

CustomizationSection:AddToggle("Show Borders", {
    Title = "Show Borders",
    Default = true,
    Callback = function(Value)
        Window.ShowBorders = Value
    end
})

CustomizationSection:AddSlider("Border Thickness", {
    ...
    Rounding = 0,
    Callback = function(Value)
        Window.BorderThickness = Value
    end
})

CustomizationSection:AddColorPicker("Border Color", {
    Title = "Border Color",
    Default = Color3.fromRGB(0, 0, 0),
    Callback = function(Value)
        Window.BorderColor = Value
    end
})

CustomizationSection:AddSlider("Corner Radius", {
    Title = "Corner Radius",
    Default = 5,
    Min = 0,
    Max = 20,
    Rounding = 0,
    Callback = function(Value)
        Window.CornerRadius = UDim.new(0, Value)
    end
})

CustomizationSection:AddToggle("Shadow", {
    Title = "Shadow",
    Default = true,
    Callback = function(Value)
        Window.Shadow = Value
...
CustomizationSection:AddSlider("Shadow Opacity", {
    ...
    Rounding = 2,
    Callback = function(Value)
        Window.ShadowOpacity = Value
    end
})

CustomizationSection:AddDropdown("Shadow Direction", {
    Title = "Shadow Direction",
    Default = "BottomRight",
    Options = {"TopLeft", "TopRight", "BottomLeft", "BottomRight"},
    Callback = function(Value)
        Window.ShadowDirection = Value
    end
})

CustomizationSection:AddToggle("Rounded Buttons", {
    Title = "Rounded Buttons",
    Default = true,
    Callback = function(Value)
        Window.RoundedButtons = Value
    end
})

CustomizationSection:AddSlider("Button Radius", {
    Title = "Button Radius",
    Default = 5,
    Min = 0,
    Max = 20,
    Rounding = 0,
    Callback = function(Value)
        Window.ButtonRadius = UDim.new(0, Value)
    end
})

CustomizationSection:AddColorPicker("Button Color", {
    Title = "Button Color",
    Default = Color3.fromRGB(0, 122, 204),
    Callback = function(Value)
        Window.ButtonColor = Value
    end
})

CustomizationSection:AddColorPicker("Button Text Color", {
    Title = "Button Text Color",
    Default = Color3.fromRGB(255, 255, 255),
    Callback = function(Value)
        Window.ButtonTextColor = Value
    end
})

CustomizationSection:AddSlider("Button Text Size", {
    ...
    Rounding = 0,
    Callback = function(Value)
        Window.ButtonTextSize = Value
    end
})

CustomizationSection:AddDropdown("Button Font", {
    Title = "Button Font",
    Default = "Gotham",
    Options = {"Gotham", "GothamBold", "Arial", "ArialBold", "SourceSans"},
    Callback = function(Value)
        Window.ButtonFont = Value
    end
})

CustomizationSection:AddToggle("Notification Sound", {
    Title = "Notification Sound",
    Default = true,
    Callback = function(Value)
        Window.NotificationSound = Value
    end
})

CustomizationSection:AddSlider("Notification Duration", {
    ...
    Rounding = 0,
    Callback = function(Value)
        Window.NotificationDuration = Value
    end
})

CustomizationSection:AddDropdown("Animation Style", {
    Title = "Animation Style",
    Default = "Fade",
    Options = {"Fade", "Slide", "Bounce"},
    Callback = function(Value)
        Window.AnimationStyle = Value
    end
})

CustomizationSection:AddToggle("Background Image", {
    Title = "Background Image",
    Default = false,
    Callback = function(Value)
        Window.BackgroundImage = Value and "rbxassetid://12345678" or ""
    end
})

CustomizationSection:AddSlider("Background Opacity", {
    ...
    Rounding = 2,
    Callback = function(Value)
        Window.BackgroundOpacity = Value
    end
})

CustomizationSection:AddDropdown("Cursor Style", {
    Title = "Cursor Style",
    Default = "Default",
    Options = {"Default", "Cross", "Hand", "Pointer"},
    Callback = function(Value)
        Window.CursorStyle = Value
    end
})

CustomizationSection:AddToggle("Tooltip", {
    Title = "Tooltip",
    Default = true,
    Callback = function(Value)
...
CustomizationSection:AddSlider("Tooltip Delay", {
    Title = "Tooltip Delay",
    Default = 0.5,
    Min = 0,
    Max = 2,
    Rounding = 2,
    Callback = function(Value)
        Window.TooltipDelay = Value
    end
})

CustomizationSection:AddToggle("Show FPS", {
    Title = "Show FPS",
    Default = false,
    Callback = function(Value)
        Window.ShowFPS = Value
    end
})

CustomizationSection:AddSlider("FPS Refresh Rate", {
    Title = "FPS Refresh Rate",
    Default = 1,
    Min = 0.1,
    Max = 5,
    Rounding = 1,
    Callback = function(Value)
        Window.FPSRefreshRate = Value
    end
})

CustomizationSection:AddToggle("Custom Cursor", {
    Title = "Custom Cursor",
    Default = false,
    Callback = function(Value)
        Window.CustomCursor = Value
    end
})

CustomizationSection:AddSlider("Cursor Size", {
    Title = "Cursor Size",
    Default = 16,
    Min = 10,
    Max = 30,
    Rounding = 0,
    Callback = function(Value)
        Window.CursorSize = Value
    end
})

CustomizationSection:AddDropdown("Cursor Color", {
    Title = "Cursor Color",
    Default = "White",
    Options = {"White", "Black", "Red", "Green", "Blue"},
    Callback = function(Value)
        Window.CursorColor = Value
    end
})

CustomizationSection:AddButton("Reset Customization", {
    Title = "Reset Customization",
    Description = "Reset all customization settings to default",
    Callback = function()
        Window.Size = UDim2.fromOffset(530, 350)
        Window.Theme = "Darker"
        Window.Acrylic = true
    end
})
